class mapParams
{
	class altis
	{
		...
		defaultPlayerSpawnPos[] = {14738.1,16662.9,0};
		lucySpawnPos[] = {8456.56,25132.1,0};
	};

	class tanoa
	{
		worldType = "fidji";
		timeFullMoon[] = {2016,6,30,0,0};
		whiteListArea = "[\
		...
		defaultPlayerSpawnPos[] = {12283.4,13971.9,0};
		lucySpawnPos[] = {12283,13969,0};
	};

	class takistan
	{
		worldType = "desert";
		timeFullMoon[] = {2016,6,29,0,0};
		whiteListArea = "[[[6499.09,6499.61,0],'RECTANGLE',[6002.91,6001.42],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {5821.4,11233.8,0};
		lucySpawnPos[] = {6025.07,11102.2,0};
	};
	...
	{
		worldType = "chern";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[6400.39,6400.12,0],'RECTANGLE',[5700.26,5699.95],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {3981.46,10188.6,0};
		lucySpawnPos[] = {133.815,229.94,0};
	};
	...
	class chernarus
	{
		worldType = "chern";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[7716.22,8102.3,0],'RECTANGLE',[7218.04,6758.17],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {4648.93,10264,0};
		lucySpawnPos[] = {13708.8,2869.94,0};
	};
	...
	class cup_chernarus_a3
	{
		...
		defaultPlayerSpawnPos[] = {4648.93,10264,0};
		lucySpawnPos[] = {13673.2,2971.31,0};
	};
	...
	class isladuala3
	{
		...
		defaultPlayerSpawnPos[] = {5949.44,6190.24,0};
		lucySpawnPos[] = {4313.08,6510.6,0};
	};
	...
	class lingor3
	{
		...
		defaultPlayerSpawnPos[] = {6754.69,6935.87,0};
		lucySpawnPos[] = {9923.75,208.365,0};
	};
	...
	class dingor
	{
		...
		defaultPlayerSpawnPos[] = {6832.08,6908.56,0};
		lucySpawnPos[] = {935.23,9209.41,0};
	};
	...
	class sara
	{
		...
		defaultPlayerSpawnPos[] = {2582.69,2710.45,0};
		lucySpawnPos[] = {9493.33,3448.66,0};
	};
	...
	class fdf_isle1_a
	{
		worldType = "chern";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[9487.25,11397.8,0],'RECTANGLE',[5813.54,8582.39],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {15880,6584.53,0};
		lucySpawnPos[] = {14046.6,5865.5,0};
	};
	...
	class woodland_acr
	{
		worldType = "chern";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[3850.91,3800.08,0],'RECTANGLE',[3449.93,3473.5],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {161.665,7588.38,0};
		lucySpawnPos[] = {381.451,7649.95,0};
	};
	...
	class pja305
	{
		worldType = "jungle";
		timeFullMoon[] = {2016,6,29,0,0};
		whiteListArea = "[[[10249.4,10211.3,0],'RECTANGLE',[9750.05,9748.92],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {13027,885.263,0};
		lucySpawnPos[] = {11786.9,1540.46,0};
	};
	...
	class pja307
	{
		...
		defaultPlayerSpawnPos[] = {5287.35,14565.9,0};
		lucySpawnPos[] = {302.839,422.334,0};
	};
	...
	class noe
	{
		...
		defaultPlayerSpawnPos[] = {8917.49,12508.5,0};
		lucySpawnPos[] = {7630.57,1195.23,0};
	};
	...
	class eden
	{
		...
		defaultPlayerSpawnPos[] = {4859.88,11799.2,0};
		lucySpawnPos[] = {1128.99,11508.8,0};
	};
	...
	class tem_kujari
	{
		worldType = "afrique";
		timeFullMoon[] = {2016,6,29,0,0};
		whiteListArea = "[[[8178.86,8046.74,0],'RECTANGLE',[7595.73,7617.96],0]]";
		blackListArea = "[\
			[[11805,14823.9,0],'RECTANGLE',[1802.54,928.486],0]\
		]";
		defaultPlayerSpawnPos[] = {11974.1,15103.8,0};
		lucySpawnPos[] = {8013.77,28.4434,0};
	};
	...
	class prei_khmaoch_luong
	{
		worldType = "jungle";
		timeFullMoon[] = {2016,6,30,0,0};
		whiteListArea = "[[[4115.72,4137.93,0],'RECTANGLE',[3543.66,3608.95],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {7379.08,757.978,0};
		lucySpawnPos[] = {7939,8405,0};
	};
	...
	class vt7
	{
		worldType = "chern";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[9000.46,8880.81,0],'RECTANGLE',[8500.53,8620.41],0]]";
		blackListArea = "[\
		...
		defaultPlayerSpawnPos[] = {13465.9,1694.1,0};
		lucySpawnPos[] = {6025.9,2718.57,0};
	};
	...
	class tem_anizay
	{
		worldType = "desert";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[5099.85,5100.2,0],'RECTANGLE',[4600.22,4600.51],0]]";
		blackListArea = "[\
			[[8949.06,7011.4,0],'RECTANGLE',[1062.86,1176.15],0],\
			[[1526.23,8657.6,0],'ELLIPSE',[209.252,270.074],86.4471]\
		]";
		defaultPlayerSpawnPos[] = {8420.35,7037.96,0};
		lucySpawnPos[] = {10201.9,135.098,0};
	};
	...
	class wl_rosche
	{
		worldType = "chern";
		timeFullMoon[] = {2016,3,30,0,0};
		whiteListArea = "[[[7700.47,7686.61,0],'RECTANGLE',[7100.47,7089.48],0]]";
		blackListArea = "[\
			[[448.13,3309.8,0],'RECTANGLE',[4129.62,1433.57],252.599]\
		]";
		defaultPlayerSpawnPos[] = {760.565,4669.13,0};
		lucySpawnPos[] = {15313.6,14936.7,0};
	};
