/*
babba= [units group player] call gaia_fnc_countgroup;abba = [units group player] call gaia_fnc_gaia_Classifygroup; cabba = [vehicle player] call gaia_fnc_countunit;
*/
//==================================================================MCC_fnc_countGroup===============================================================================================
//
//
...
//,[_at, _aal, _aah]];
_Assets = [_units] call gaia_fnc_CountUnitTypes;
