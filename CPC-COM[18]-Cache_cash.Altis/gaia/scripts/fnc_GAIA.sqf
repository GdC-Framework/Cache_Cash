...
while {true} do
{
		...
		while { ( {side _x == _HQ_side } count allunits > 0 ) } do
		{
				...
				_mklist = [_HQ_side, _mklist] call gaia_fnc_GAIA_AnalyzeTargets;
				sleep 1;
				...
				_dummy = [_HQ_side] call gaia_fnc_GAIA_ConflictAreas;
				sleep 1;
				...
				_dummy = [_HQ_side] call gaia_fnc_GAIA_AnalyzeForces;
				sleep 1;
				...
				_dummy = [_HQ_side] call gaia_fnc_GAIA_Classify;
				sleep 1;
				...
				_dummy = [_HQ_side] call gaia_fnc_GAIA_IssueOrders;
				sleep 1;
