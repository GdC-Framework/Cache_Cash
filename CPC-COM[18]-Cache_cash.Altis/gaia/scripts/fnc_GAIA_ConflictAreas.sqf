//==================================================================Conflict Area's===============================================================================================
//a=[WEST] call gaia_fnc_GAIA_ConflictAreas; PLAYER setPoS (A SELECT 1)
//
//
//===========================================================================================================================================================================
...
//_ca=[_ca,[],{[_HQ_side, _x] call gaia_fnc_GetDistanceClosestZone;}, "ASCEND"] call BIS_fnc_sortBy;
if (count(_ca)>0) then
	{
		_CA=[_CA,[],{[_HQ_side, _x] CALL gaia_fnc_GetDistanceClosestZone;}] call BIS_fnc_sortBy;
	};
