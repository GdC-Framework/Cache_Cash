...
while {MCC_GAIA_CACHE} do
{
			...
			then
				{
							...
							switch(true)do
							{
											...
											case (
																...
																and
																!([getPosATL(leader _x),GAIA_CACHE_STAGE_1] call gaia_fnc_nearPlayer)
																and
										 ...
										 //We are cached, player is in range 1
					  					...
					  					case (
 											...
 											default {_x spawn gaia_fnc_sync;};
							};


							//Cache stage 2
							if (
											!([getPosATL(leader _x),GAIA_CACHE_STAGE_2] call gaia_fnc_nearPlayer)
											//and
											//(behaviour(leader _x)!="COMBAT")
											/*
											and
					   	...
					   	then 	{[_x] call gaia_fnc_cache_stage_2;};
	 ...
	 _idx = 0;
	 {
	 						...
	 						if ([_x,GAIA_CACHE_STAGE_2] call gaia_fnc_nearPlayer)
	 						then
	 						{
	 							[(missionNamespace getVariable [ "GAIA_CACHE_" + str(_x),[0,0,0]])] call gaia_fnc_uncache_stage_2;
