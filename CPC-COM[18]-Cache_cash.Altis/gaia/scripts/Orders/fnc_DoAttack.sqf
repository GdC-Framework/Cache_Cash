...
{			
	...
	if (!IsNil("_class") ) then
	{
		switch(_class) do
		{
			...
			//Infantry
			case "Infantry":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackInf;};
			case "ReconInfantry":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackRecon;};
			case "Car":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackCar;};
			case "MotorizedRecon":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackMotorRecon;};
			case "MechanizedInfantry":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackMechInf;};
			case "MotorizedInfantry":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackMotorInf;};
			case "Tank":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackMotorRecon;};
			case "Helicopter":
				{ _dummy= [_group, _TargetPos] call gaia_fnc_DoAttackHeli;};
