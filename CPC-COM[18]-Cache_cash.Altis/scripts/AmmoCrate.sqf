...
switch (CC_p_loaout) do {
	...
	case 5 : {
		...
		_arsenal_items_faction = [
			...
			//weapon items
			"cup_optic_smaw_scope","rhs_weap_optic_smaw","rhs_optic_maaws","acc_flashlight_pistol","rhsusf_acc_omega9k","rhsusf_acc_anpeq15_wmx","rhsusf_acc_anpeq15_bk","rhsusf_acc_anpeq15","rhsusf_acc_m2010s_wd","rhsusf_acc_m2010s_sa",
