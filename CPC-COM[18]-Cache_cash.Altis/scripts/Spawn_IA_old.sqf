...
switch (CC_p_ennemy) do {
	...
	case 22 : { // CDF winter CUP
		_compo_group = [
			["CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_MG_SNW"],
			["CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_GL_SNW"],
			["CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_LAT_SNW","CUP_B_CDF_Medic_SNW"],
			["CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_LAT_SNW","CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Medic_SNW","CUP_B_CDF_Soldier_AR_SNW"],
			["CUP_B_CDF_Soldier_Marksman_SNW","CUP_B_CDF_Soldier_SNW"]
		];

		_binome = ["CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_SNW"];
		_ennemi_group = ["CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_SNW","CUP_B_CDF_Soldier_GL_SNW","CUP_B_CDF_Soldier_LAT_SNW","CUP_B_CDF_Soldier_MG_SNW"];
		_rand_vehi = ["CUP_B_MTLB_pk_Winter_CDF","CUP_B_MTLB_pk_Winter_CDF","CUP_B_BRDM2_CDF","CUP_B_T72_CDF"];
		_transp_vehi = "CUP_B_Ural_CDF";
		_offroad = "CUP_B_UAZ_MG_CDF";
		_helico = "CUP_B_Mi17_CDF";
	};
