...
loadoutCC_MG = //
{
	_unit = _this select 0;
	_unit setUnitLoadout [
		["CUP_lmg_M60E4_norail","","","",["CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M",100],[],""],
		[],
		[],
		[_uniform,_itemsU_base],
...
loadoutCC_M = //
{
	_unit = _this select 0;
	_unit setUnitLoadout [
		["CUP_srifle_M14_DMR","","","cup_optic_leupoldmk4",["20Rnd_762x51_Mag",20],[],""],
		[],
		_pistol,
		[_uniform,(_itemsU_base + [["ACE_RangeCard",1]])],
		[_vest,[["CUP_HandGrenade_M67",1,1],["SmokeShell",1,1],["20Rnd_762x51_Mag",7,20]]],
		[],
		_helmet,
		"",
		["Binocular","","","",[],[],""],
...
loadoutCC_GL = //
{
	_unit = _this select 0;
	_unit setUnitLoadout [
		["CUP_arifle_M16A2_GL","","","",["CUP_20Rnd_556x45_Stanag",20],["CUP_1Rnd_HE_M203",1],""],
		[],
		[],
		[_uniform,_itemsU_base],
...
loadoutCC_PILOT = //
{
	...
	_unit setUnitLoadout [
		...
		"",
		[],
		["ItemMap","","","ItemCompass","ItemWatch",(if (CC_p_nvg > 0) then {"CUP_NVG_PVS7"} else {""})]
	];
};
