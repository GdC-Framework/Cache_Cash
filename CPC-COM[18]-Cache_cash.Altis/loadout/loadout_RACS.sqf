...
hard_setLoadout = 
{
	...
	switch (cc_loadoutcamo) do {
		case "winter": {
			...
			_helmet = "CUP_H_RACS_Helmet_TPAT";
			_helmet_tl = "CUP_H_RACS_Helmet_Headset_TPAT";
		...
		case "jungle": {
			...
			_helmet_tl = "CUP_H_RACS_Helmet_Headset_mech";
		...
		case "desert": {
			...
			_helmet_tl = "CUP_H_RACS_Helmet_Headset_DES";
		...
		default {
			...
			_backpack_big = "B_Carryall_oli";
			_backpack_med = "CUP_B_AlicePack_OD";
			_helmet = "CUP_H_RACS_Helmet_wdl";
			_helmet_tl = "CUP_H_RACS_Helmet_Headset_wdl";
			_vest_1 = "CUP_V_B_Interceptor_Rifleman_Olive";
			_vest_2 = "CUP_V_B_Interceptor_Grenadier_Olive";
			_hat = "H_Bandanna_khk";
		};
...
loadoutCC_PILOT = //
{
	...
	_unit setUnitLoadout [
		...
		"",
		[],
		["ItemMap","","","ItemCompass","ACE_Altimeter",(if (CC_p_nvg > 0) then {"CUP_NVG_PVS7"} else {""})]
	];
};
...
loadoutCC_SNIPER = //
{
	_unit = _this select 0;
	_unit setUnitLoadout [
		[(if (cc_loadoutcamo == "desert") then {"CUP_srifle_M24_des"} else {"CUP_srifle_M24_blk"}),"","","cup_optic_leupoldmk4",["CUP_5Rnd_762x51_M24",5],[],"bipod_01_f_blk"],
		[],
		_pistol,
		[_uniform,_itemsU_tl],
