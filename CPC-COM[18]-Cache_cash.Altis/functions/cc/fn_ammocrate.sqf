...
switch (CC_p_loaout) do {
	...
	case 11 : {
		...
		_arsenal_items_faction = [
			"CUP_U_I_RACS_mech_1","CUP_U_I_RACS_mech_2","H_Bandanna_gry","CUP_V_B_Interceptor_Grenadier_Grey","CUP_V_B_Interceptor_Rifleman_Grey","CUP_H_PASGTv2_NVG_Urban","B_FieldPack_blk","B_MU_Carryall_blk","CUP_U_I_RACS_Urban_1","cup_acc_flashlight","CUP_NVG_PVS7",
			"CUP_H_PASGTv2_NVG_desert","B_FieldPack_cbr","B_Carryall_cbr","CUP_U_I_RACS_Desert_2","CUP_U_I_RACS_Desert_1","H_Bandanna_khk","CUP_V_B_Interceptor_Grenadier_Olive","CUP_V_B_Interceptor_Rifleman_Olive","CUP_H_PASGTv2_NVG_ERDL_lowland","CUP_H_PASGTv2_NVG_tigerstripe","CUP_B_AlicePack_OD","B_Carryall_oli",
			"CUP_SMAW_HEAA_M","cup_optic_smaw_scope","CUP_launch_Mk153Mod0","CUP_launch_M136","CUP_U_I_RACS_WDL_2","CUP_U_I_RACS_WDL_1","H_Bandanna_sand","CUP_V_B_Interceptor_Grenadier_Coyote","CUP_V_B_Interceptor_Rifleman_Coyote",
	...
	case 20 : {
		...
		_arsenal_items_faction = [
			"H_Booniehat_tan","CUP_H_US_patrol_cap_desert","CUP_H_PASGTv2_NVG_winter","CUP_U_B_BDUv2_Winter","CUP_U_B_BDUv2_gloves_Winter","CUP_V_B_PASGT_winter","CUP_H_FR_BeanieGreen","CUP_H_US_patrol_cap_winter","CUP_H_PASGTv2_NVG_desert","CUP_B_AlicePack_OD","CUP_U_B_BDUv2_desert_US","CUP_U_B_BDUv2_desert_US","CUP_U_B_BDUv2_roll2_desert_US","CUP_U_B_BDUv2_roll_desert_US","cup_acc_flashlight","CUP_NVG_PVS7",
			"CUP_MAAWS_HEDP_M","CUP_MAAWS_HEAT_M","cup_optic_maaws_scope","CUP_launch_MAAWS","CUP_launch_M72A6","CUP_V_B_PASGT_OD","CUP_H_FR_PRR_BoonieWDL","CUP_H_US_patrol_cap_WDL","CUP_H_PASGTv2_NVG_OD","CUP_U_B_BDUv2_M81_US","CUP_U_B_BDUv2_M81_US","CUP_U_B_BDUv2_roll2_M81_US","CUP_U_B_BDUv2_roll_M81_US","CUP_V_B_PASGT",
